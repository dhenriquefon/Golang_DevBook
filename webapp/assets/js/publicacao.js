...
function curtirPublicacao(evento) {
    ...
    $.ajax({
        ...
        const quantidadeCurtidas = parseInt(contadorDeCurtidas.text())

        contadorDeCurtidas.text(quantidadeCurtidas+1)
...
function atualizarPublicacao() {
    ...
    $.ajax({
       ...
       Swal.fire('Sucesso', 'Publicação Criada com Sucesso', 'success')
        ...
        Swal.fire("Ops...", "Erro ao alterar a publicação", "error")
    }).always (function() {
...
function deletarPublicacao(evento) {
    ...
    Swal.fire( {
        title: "Atenção!",
        text: "Tem certeza que deseja excluir essa publicação? Ação irreversível",
